...
<div class="wrapper">
 ...
 <!--  main container -->
  ...
  <!--  bootrap container -->
    ...
    <div class="row">
  <b> <label>Parent's details: </label></b>
<table class="table table-striped dark"style="margin-top: 20px;">
    ...
    foreach($parentdata as $row)
     {
      echo "<tr>";
       ...
       echo "<th scope ='row'>".$row->studentname."</th>";
        echo "<th>".$row->name."</th>";
              echo "<th>".$row->email."</th>";
                echo "<th>".$row->phone."</th>";
                  echo "<th>".$row->occupation."</th>";
                    echo "<th>".$row->sallery."</th>";
                      echo "<th>".$row->address."</th>";
                      echo "<th>".$row->gender."</th>";
                        echo "<th>";
                       echo "<href=''> <i class='fa fa-edit'title='update'></i></a>";
                       echo "<a href='deleteparentdata?id=".$row->id."'><i class='fa fa-1x fa-trash'style='color:red;'title='Delete'></i></a>";
