       ...
       echo "<th scope ='row'>".$row->id."</th>";
        ...
        echo "<th>".$row->fathername."</th>";
              echo "<th>".$row->mothername."</th>";
               echo "<th>".$row->roll_no."</th>";
                  echo "<th>".$row->class."</th>";
                    echo "<th>".$row->whole_mark."</th>";
                      echo "<th>".$row->obtent_mark."</th>";
                      echo "<th>".$row->percentage."</th>";
                        echo "<th>";
                       echo "<href=''> <i class='fa fa-edit'title='update'></i></a>";
                       echo "<a href='deletereporcard?id=".$row->id."'> <i class='fa fa-1x fa-trash'style='color:red;'title='Delete'></i></a>";
                        echo "</th>";
                        echo "</tr>";
