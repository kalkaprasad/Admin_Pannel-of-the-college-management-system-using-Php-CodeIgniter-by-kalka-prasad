...
<div class="wrapper">
  ...
  <div class="sidebar">
      <ul>
           ...
           <li><a href="<?php echo base_url();?>index.php/manage/dashboard"class="active">
 ...
 <!--  main container -->
  ...
  <!--  bootrap container -->
    ...
    <div class="row">
  <b> <label>Students details: </label></b>
                    ...
                    echo "<th>".$row->address."</th>";
                      ...
                      echo "<th>".$row->gender."</th>";
                       echo "<th>".$row->category."</th>";
                        echo "<th>";
                        echo "<img src='http://localhost/collegemange/assests/image/upload.jpg'style='border-radius: 50%;hight:50px;width:50px;'";

                        echo "</th>";
                        echo "<th>";

                       echo "<href=''> <i class='fa fa-edit'title='update'></i></a>";
                       echo "<a href='deleteStudent?regsid=".$row->registration_number."'> <i class='fa fa-1x fa-trash'style='color:red;'title='Delete'></i></a>";
                     //  echo "<a href='#''><i class='fa fa-trash-o fa-fw'style='color:red;'title='Delete'></i>";
                        echo "</th>";
