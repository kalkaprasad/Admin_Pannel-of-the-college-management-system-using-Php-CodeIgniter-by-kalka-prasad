              ...
              echo "<th>".$row->email."</th>";
                echo "<th>".$row->phone."</th>";
                  echo "<th>".$row->class."</th>";
                    echo "<th>".$row->paymentRefno."</th>";
                      echo "<th>".$row->feeAmount."</th>";
                      echo "<th>".$row->address."</th>";
                        echo "<th>";
                       echo "<href=''> <i class='fa fa-edit'title='update'></i></a>";
                       echo "<a href='delerefeedata?id=".$row->id."'> <i class='fa fa-1x fa-trash'style='color:red;'title='Delete'></i></a>";
                        echo "</th>";
                        echo "</tr>";
